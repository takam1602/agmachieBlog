...
CLOUDFLARE_R2_ACCESS_KEY_ID=R2 API token の Access Key ID
CLOUDFLARE_R2_SECRET_ACCESS_KEY=R2 API token の Secret Access Key
CLOUDFLARE_R2_BUCKET=agmachine-img
CLOUDFLARE_R2_PUBLIC_BASE_URL=https://pub-906e51e4bcd34953a92347dad61b514c.r2.dev
CLOUDFLARE_R2_PREFIX=notes
```
...
メモ編集画面の画像追加は Cloudflare R2 の `agmachine-img` bucket にアップロードし、本文には
`![alt](https://pub-906e51e4bcd34953a92347dad61b514c.r2.dev/notes/...)` の Markdown を挿入します。
