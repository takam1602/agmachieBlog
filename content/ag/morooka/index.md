...
- [会社の沿革](https://www.morooka.co.jp/company/history)
- [youtube の会社案内](https://www.youtube.com/watch?v=EO0QuQMJbwk)
- 手持ちのカタログ

を参照して歴史をまとめてみる．

- 本社跡や苫小牧工場，熊本工場の跡地については
[別ページ](./ruins.md)
...
# 1980年 - 1990年: ゴムクローラトラクタ黎明期: 龍ケ崎の工場でほそぼそと，何か形になるものを作っていた．準備段階.
...
- ゴムクローラー　ゲレンデ整備車 MGM ADVENTURE(1990?-1991?)
    ...
    MGM-200なるゲレンデ整備車を1990年の冬とぴあで展示していた，ということはMGM280は1990年の機械でゲレンデ整備車は1990年以前には開発していたことになる．

    1992年のゆきみらいでは展示しなくなっちゃった... 

- トラクターシリーズ ゴムクローラー　 MK シリーズ(1991-1997)
    - MCTからMKにモデル変更．
        - MK はMorooka Kazuo諸岡一雄さんの略称，との噂も
        - ラインナップがとんでもないことに．
...
- トラクターシリーズ ゴムクローラー　 MK-S シリーズ(1997-)
    - キャビンの安全鑑定を受け，MKシリーズがSになった(SaftyのS?)．
...
# おまけ(三菱農機のゴムクローラトラクタ関連)

三菱農機は，独自にレーザーシステムを自社のゴムクローラトラクタ開発に取り入れようと，積極的だった時期がある．
そのときに開発されたいくつかの変態システム

- MITSUBISHI のカッティングレーザーロータリー

これはどちらかというと、三菱かも。
三菱農機のクローラトラクタ(クロトラ)でレーザー作業する際に、開発された機械の一つ。
...
- [不整地フォークリフト](https://www.j-platpat.inpit.go.jp/c1801/PU/JP-2000-233900/11/ja)
...
主マスト３４はシャーシフレーム２の前端に軸４１で枢着され、凹凸面を移動しても邪魔とならない比較的高い位置に保持され、主マスト３４対して動作第１シリンダにより補助マスト３５が往復動し、補助マスト３５に対してフォーク付きマスト３６が往復動する。

- [ターントラクタ](https://www.j-platpat.inpit.go.jp/c1801/PU/JP-2893011/15/ja)

カタログではマルチトラクターと呼ばれていたもの。

れんこんハーベスタとして使用を予定していたのだろう。
色々なバケットが書かれている。

ブーム取付部、運転部及びエンジン台を含むフレームを、前後の車輪を懸架するシャーシフレーム対して旋回可能とするターントラクタを提供する。

【解決手段】  

旋回フレーム３は、ブーム取付部、運転部及びエンジン台から一体に構成され、エンジン台は、エンジン及びオイルポンプを載置し、運転部より上方に位置するとともに、旋回フレーム３が旋回しても、シャーシフレーム２の前後の車輪４、５に衝接しないように前後の車輪４、５の上端より上方に位置している。

- [れんこんハーベスタ](https://www.j-platpat.inpit.go.jp/c1801/PU/JP-H11-103633/11/ja)

これは知らない、なにこれ、


蓮田内で機動性よく移動でき、蓮根を圧搾空気により掘り起こし、これを自動的に収穫できる蓮根掘り機を得る。

【解決手段】 

連結器により互いに回転自在に連結され、操舵可能な前方及び後方フロートを有し、夫々のフロートは油圧モータにより四輪駆動される水田車輪が取り付けられ、前方フロートには、油圧シリンダーにより動作可能なブーム、アーム及びバケットから成る作業装置を水平旋回可能に取り付ける。

- [ターントラクタ2 ](https://www.j-platpat.inpit.go.jp/c1801/PU/JP-2873228/15/ja)

分割出願。

ブーム取付部、運転部及びエンジン台を含むフレームを、車輪を懸架するシャーシフレーム対して旋回可能とするターントラクタにより各種の作業ができるようにする。

【解決手段】 

旋回フレーム３は、ブーム取付部、運転部及びエンジン台から一体に構成され、エンジン台は、エンジン３０及びオイルポンプを載置し、運転部より上方に位置するとともに、旋回フレーム３が旋回しても、シャーシフレーム２の前後の車輪４、５に衝接しないように前後の車輪４、５の上端より上方に位置し、アーム７の先端に、各種の用途に応じて構成された作業用バケット６７を着脱自在に取付ける取付フォーク６８を設ける。

- [穀類収穫機](https://www.j-platpat.inpit.go.jp/c1801/PU/JP-H09-327224/11/ja)

稲の穂から籾のみを収穫する動作を行う作業機を、小型で構成の簡単なものとして構成し、小型のトラクタ等の装置に容易に装備できるようにする。

【解決手段】 

小型のトラクタ１に装備する作業機４０は、作業機用支持部材３０を介して配置するバケット部材４１に対して、収穫機５０と籾と藁を分離するスクリーン部材４５とを組み合わせて構成し、櫛歯部を先端部に設けた刃部材５５……により、稲の穂から籾のみをしごき取ってバケット部材に収容させ得るようにする。

そして、収穫作業の途中で、前記バケット部材を傾動させたりすることにより、バケット部材の内部に収容する籾を奥の側に移動させて、バケット部材における収容効率を向上させながら作業を続行する。

- [油圧走行車両](https://www.j-platpat.inpit.go.jp/c1801/PU/JP-H09-309466/11/ja)

農業用のトラクター等に使用する車両において、車体の前後に配置する走行輪の轍が２条のみ形成され、農地等を荒らすことがなく、走行性の良い車両を得ること、および駆動伝達機構を簡素化した油圧駆動作業車両を得る。

【解決手段】

油圧駆動作業車両１はエンジンを装備する前部車体２と操作部を配置する後部車体５とを別個の車体として構成し、２つの車体を接続部５０に配置する接続ピン部材５１を用いて接続し、接続ピン部材の両側に配置するシリンダ装置を用いて操向する。

また、走行用の駆動を油圧を用いて行い、ＰＴＯ４０に対しては、ギヤ装置を用いて駆動伝達して、走行の制御と操作性とを良好に設定できるようにする。

- [フォークに作業装置を装備する作業車両](https://www.j-platpat.inpit.go.jp/c1801/PU/JP-H09-194199/11/ja)

農業用トラクターをフォーク装置を用いて構成し、フォーク装置としての機能に加えて、フォークに作業装置を装備することにより、任意の作業に対応させ得るようにする。

【解決手段】 

作業車両の前部分に配置するフォーク２１に対して作業装置４０を装備し、前記作業装置を作業機支持フレーム４１の上部に配置する駆動装置４５と、下部に配置する草刈り装置５０とを組み合わせたユニットとして構成する。

前記草刈り装置には垂直軸に回転する円板状部材５１に対して、多数の切断刃物５３……を配置して、草刈りに使用するもので、駆動装置に配置する油圧モータ４６には、動力発生装置からエンジンの出力の全部を油圧として供給できるような装置を構成する。

- [ゴムクローラ](https://www.j-platpat.inpit.go.jp/p0200)

ゴムクローラを装備した車両に横滑りが生じることを防止するために、ラグの形状を変更して、走行性能を向上させる。

【解決手段】 

雪上車等の走行部に装備するゴムクローラ１０には、クローラ本体１１の走行面にラグを所定の高さで突出させて設けており、前記ラグ２０は、平行ラグ２１両側部に配置するＶ状ラグ２５から構成される。

そして、前後のラグにより区画される凹部２４に、雪をブロック状に区画して圧密し、横滑りに際しての雪の剪断抵抗を大きく設定し、ゴムクローラの横滑り作用を防止するとともに、Ｖ状ラグにより横方向の抵抗力を大きくする。

- [走行車両](https://www.j-platpat.inpit.go.jp/p0200)

農地等を走行する作業車両において、ローターにより推進力を得る機構を設け、該ローターにより生じる揚力を用いて、タイヤの接地圧を低く設定して、軟弱な地面の上でも容易に走行させ得るようにする。

【構成】

走行車両１の走行部には、所定の間隔をおいて左右に配置した前輪１１と、１つの車輪を配置した後輪１０とを設けて、車体の重量を支持させるとともに、後輪による操舵を行い得るようにする。

また、車体の前部には、水平位置に対して角度θだけ傾斜したローター軸２１を配置し、該ローター軸の先端部に設けたローター２０を回転させて、車両の走行時の接地圧を低下させるようにする。

さらに、前輪１１では、車輪の間隔を変化させ得る機構を設けて、作業時の走行の安定性を向上させ高速走行を可能にするとともに、作業しないときの移動性を向上させ得るようにする。

- [穀類収穫機](https://www.j-platpat.inpit.go.jp/c1801/PU/JP-H05-316861/11/ja)

これは、農機新聞に掲載されていたやつ。

トラクターに設ける収穫装置において、脱穀機に向けて空冷エンジンの熱を導入し、穀物が濡れている状態でも、収穫作業を行い得る機構を構成すること、および、各作業装置を１つの油圧ポンプを用いて駆動し、それ等の装置の油圧モータを直列状に配置して、駆動機構を簡素化する。

【構成】

トラクター１の前側にコンバイン２５を取り付け、本体には脱穀機１０を設けて収穫装置を構成する。

前記脱穀機１０に対してエンジン３からの熱風をダクト３０を介して導入し、藁と穀粒に付着する水分の除去を行うようにする。

また、エンジン３には、３個の油圧ポンプを直列に接続し、それ等の油圧ポンプのうちの１つを作業機の駆動用に用いる。

前記各作業機の油圧ポンプは、油圧回路を直列に接続して、穀物に適した回転数で駆動できるようにする。


- [トラクターに設ける作業装置](https://www.j-platpat.inpit.go.jp/c1801/PU/JP-H05-163744/11/ja)

- [ビーチクリーナ](https://www.j-platpat.inpit.go.jp/c1801/PU/JP-S61-277707/11/ja)

- [除雪装置](https://www.j-platpat.inpit.go.jp/c1801/PU/JP-S61-274004/11/ja)

- [油圧走行車両](https://www.j-platpat.inpit.go.jp/c1801/PU/JP-S59-160665/23/ja)

- [トレンチャー](https://www.j-platpat.inpit.go.jp/c1801/PU/JP-S52-115505/11/ja)
