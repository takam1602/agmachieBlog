...
- K農場(由仁): 3台
初代65から，ずっとある．
45は2台.ではなく4台あるかもとのこと．公社の払い下げかも．
...
AGCO に移る前の，Dekalb 最後のトラクター，CATのチャレンジャー．Cat が持ってきたのかな．
    ...
    麦刈りの合間にktngnmのktymさんに会って，MT755Aを見せてもらった．
    caterpillar ビルドでカリフォルニアのHOLTというところから引いたもののようだ．
    また，MT Aトラクターは日本に3台あるらしく，MT745Aが南幌に，MT755Aがktngnmに，MT765Aが本別にあるようだ．

    ただ見せてもらうだけじゃなくて，ディスプレイがスペイン語から英語に変更した．

    気がかりなのは，MT Aシリーズのディスプレイの最初に
    Caterpillar Corpolation 1999 
    と表示されることで，MTAは2002年に発表のはずなのに，なぜか．

    1999年から販売しているシリーズの85Dや95Dなどの高馬力トラクターに搭載されていたディスプレイと同じソフトウェアを使用しているためだと考えられるが，実際にカタログを見てみないとディスプレイが搭載されていたかは不明である．
...
スーツケースウェイト付きなので、ディカルブ生産のものですね。

- ベジタブルワークス: 1台?

インスタに載ってたやつ。
![](/img/vegeworks_challenger_insta.png)
...
- 群馬: なぜか55(訂正: 45)がヤフオクに売られてた: 明後日でどころを聞いてくる。
    - [55ではなく45](https://auctions.yahoo.co.jp/jp/auction/m1198304617)

ではなかった。
1DR から始まるので、これは45である。
